...
#[cfg(test)]
mod tests {
    use super::FederatedUser;

    #[test]
    fn check_valid_federated_users() {
        let f1 = FederatedUser::new("aws", "123456789012", "user@domain").unwrap();
        ...
        assert_eq!(
            FederatedUser::new("aws", "123456789012", "user@domain-with_32-characters==",).unwrap().to_string(),
